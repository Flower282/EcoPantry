# **Hệ thống đi chợ tiện lợi \- EcoPantry**
...
# **3\. Một số chức năng chính(sinh viên có thể khảo sát thêm các hệ thống hoặc sản phẩm tương tự nhằm đề xuất thêm các chức năng bổ sung nếu có)**
